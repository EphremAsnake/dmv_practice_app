class Keys {
  static String baseurl = "https://buy.et/devwork/dmv_practice_app/v1-pro";
  ...
  static String allUsStatesCacheKey = "All Us States Cache Key";
  static String studySignsCacheKey = "Study Signs Cache Key";
}
